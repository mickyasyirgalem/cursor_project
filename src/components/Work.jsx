...
import websiteScreenshot from '../assets/website.png'
import erpScreenshot from '../assets/erp.png'
...
export default function Work() {
 ...
 <span>Share assets</span>
  ...
  <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 justify-items-center overflow-visible">
        <a
          href="https://yonasmetalandcement.com"
          target="_blank"
          rel="noopener noreferrer"
          className="group rounded-xl overflow-hidden border dark:border-white/10 bg-white hover:-translate-y-3 hover:scale-[1.12] hover:shadow-2xl dark:hover:shadow-violet-500/40 transition-all duration-300 transform border-zinc-200/70 dark:bg-zinc-900 animate-fade-in min-w-[320px] hover:z-20 origin-center"
        >
          <div className="aspect-[16/9] bg-zinc-100 dark:bg-zinc-900 overflow-hidden">
            <img src={websiteScreenshot} alt="Yonas Metal and Cement marketing website" className="w-full h-full object-cover" />
          </div>
        ...
        <article className="group rounded-xl overflow-hidden border dark:border-white/10 bg-white hover:-translate-y-3 hover:scale-[1.12] hover:shadow-2xl dark:hover:shadow-violet-500/40 transition-all duration-300 transform border-zinc-200/70 dark:bg-zinc-900 animate-fade-in min-w-[320px] hover:z-20 origin-center">
          <div className="aspect-[16/9] bg-zinc-100 dark:bg-zinc-900 overflow-hidden">
            <img src={erpScreenshot} alt="Inventory and order management dashboard" className="w-full h-full object-cover" />
          </div>
            <div className="p-4 group-hover:bg-zinc-50 dark:group-hover:bg-zinc-800/50 transition-colors duration-300">
              <div className="flex items-center gap-2 text-xs">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md dark:bg-white/10 border dark:border-white/20 bg-zinc-100 text-zinc-700 dark:text-zinc-200 border-zinc-200/70 group-hover:scale-105 transition-transform duration-300">
        ...
        <article className="group rounded-xl overflow-hidden border dark:border-white/10 bg-white hover:-translate-y-3 hover:scale-[1.12] hover:shadow-2xl dark:hover:shadow-violet-500/40 transition-all duration-300 transform border-zinc-200/70 dark:bg-zinc-900 animate-fade-in min-w-[320px] hover:z-20 origin-center">
          <div className="aspect-[16/9] bg-zinc-100 dark:bg-zinc-900 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200&auto=format&fit=crop" alt="Banking and finance" className="w-full h-full object-cover" />
            </div>
            <div className="p-4 group-hover:bg-zinc-50 dark:group-hover:bg-zinc-800/50 transition-colors duration-300">
              <div className="flex items-center gap-2 text-xs">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md dark:bg-white/10 border dark:border-white/20 bg-zinc-100 text-zinc-700 dark:text-zinc-200 border-zinc-200/70 group-hover:scale-105 transition-transform duration-300">
        ...
        <article className="group rounded-xl overflow-hidden border-2 border-dashed dark:bg-white/5 hover:border-violet-400/70 hover:scale-[1.07] transition border-zinc-300 dark:border-zinc-600 bg-zinc-50/70 transform min-w-[320px] hover:z-10 origin-center">
